...
return res.json({
    ...
    users: {
        ...
        { method: 'GET', path: '/:id', description: 'Obtém um usuário específico' },
        { method: 'POST', path: '/', description: 'Cria um novo usuário' },
        { method: 'PATCH', path: '/:id', description: 'Atualiza um usuário existente' },
    ...
    pius: {
        ...
        { method: 'GET', path: '/:id', description: 'Obtém um piu específico' },
        { method: 'GET', path: '/user/:userId', description: 'Lista pius de um usuário' },
        { method: 'GET', path: '/search/:query', description: 'Busca pius por texto' },
        { method: 'GET', path: '/trending/:count', description: 'Obtém pius aleatórios' },
